...
class DataOutputConfig(BaseModel):
    ...
    csv_export_path: str = "./output"
    enable_json_export: bool = False
    json_export_path: str = "./output"


class OutputConfig(BaseModel):
    algorithm_name: str = "default_algo"
    algorithm_version: str = "1.0.0"
    health_score_interval_minutes: int = 10
    logging: Optional[LoggingConfig] = None
    data_output: Optional[DataOutputConfig] = None
...
class AppConfig(BaseModel):
    ...
    # [ADDED] Output config is required for logging setup in main.py
